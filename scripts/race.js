  ...
  wheelDb
    ...
    .catch((err) => {
      ...
      if (err.code === "failed-precondition") {
        container.innerHTML =
          '<p class="wheel-status">Firestore braucht noch einen Suchindex fürs Rennen. ' +
          "Öffne die Browser-Konsole (F12) - dort zeigt Firebase einen Link zum " +
          "automatischen Erstellen an. Einmal klicken, kurz warten (1-2 Minuten), " +
          "dann Seite neu laden.</p>";
      } else {
