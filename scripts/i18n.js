...
const translations = {
  de: {
    ...
    "giveaway.loadingPool": "Lade Teilnehmerkreis ...",
    "giveaway.loadingWinner": "Lade letzte Ziehung ...",
    "giveaway.note": "Jeder, der sich angemeldet hat (Twitch-Login oder Name im 🎮 Anmelden-Bereich), ist automatisch im Lostopf. Nichts weiter zu tun!",
    "giveaway.historyTitle": "Bisherige Ziehungen",
  },
  ...
  en: {
    ...
    "giveaway.loadingPool": "Loading participant pool ...",
    "giveaway.loadingWinner": "Loading last draw ...",
    "giveaway.note": "Anyone who has logged in (Twitch login or name in the 🎮 Login area) is automatically entered. Nothing else to do!",
    "giveaway.historyTitle": "Past draws",
  },
};
