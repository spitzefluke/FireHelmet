...
const translations = {
  de: {
    ...
    "detectiveCase.cluesHeading": "🔎 Hinweise",
    "detectiveCase.boardHeading": "📌 Ermittlungstafel",
    "detectiveCase.timelineHeading": "🕰️ Die Tatnacht",
    "detectiveCase.timelineHint": "Jeder untersuchte Hinweis trägt hier etwas ein. Wer sich selbst widerspricht, fällt auf.",
    "detectiveCase.timelineEmpty": "Noch nichts eingetragen. Untersuche die Hinweise.",
    "detectiveCase.notesHeading": "📝 Deine Einschätzung",
    "detectiveCase.noteSuspect": "verdächtig",
    "detectiveCase.noteCleared": "entlastet",
    "detectiveCase.noteNone": "offen",
    "detectiveCase.threadHint": "Wähle einen Verdächtigen - die Fäden zeigen, was über ihn bekannt ist.",
    "detectiveCase.clueRelation.entlastet": "spricht dafür",
    "detectiveCase.clueRelation.belastet": "spricht dagegen",
    "detectiveCase.clueRelation.widerspruch": "widerspricht der Aussage",
    "detectiveCase.zeit.flitzKajuete": "Käpt'n Flitz: allein in der Kajüte (unbestätigt)",
    "detectiveCase.zeit.andiiSpielothek": "Ändii: in der Spielothek (Gäste bestätigen)",
    "detectiveCase.zeit.brunoKombuese": "Smutje Bruno: in der Kombüse (Küchenprotokoll)",
    "detectiveCase.zeit.finnAusguck": "Ausguck Finn: sah niemanden auf dem Hauptdeck",
    "detectiveCase.zeit.kammerOffen": "Schatzkammer zuletzt geöffnet",
    "detectiveCase.zeit.gloeckchen": "Glöckchen an Deck ausgelöst",
    "detectiveCase.zeit.roterMantel": "Roter Mantel nahe der Schatzkammer gesehen",
    "detectiveCase.zeit.stiefel": "Nasse Stiefelabdrücke vor der Kammer",
    "detectiveCase.investigateCta": "🔍 Untersuchen",
    "detectiveCase.accuseButton": "🔎 VERDÄCHTIGEN BESCHULDIGEN",
    "detectiveCase.confirmAccuse": "Bist du dir sicher? Ein falscher Vorwurf könnte den wahren Täter warnen.",
    "detectiveCase.wrong.title": "❌ Falsche Spur.",
    "detectiveCase.wrong.text": "Deine Beweise reichen nicht aus. Der wahre Täter ist noch an Bord.",
    "detectiveCase.wrong.hint": "Vielleicht solltest du die Aussagen noch einmal miteinander vergleichen.",
    "detectiveCase.solved.reveal": "🕵️ FALL GELÖST!",
    "detectiveCase.solved.revealLine1": "Du hast den Täter entlarvt.",
    "detectiveCase.solved.revealLine2": "Die 400 verschwundenen Dublonen wurden gefunden.",
    "detectiveCase.solved.heading": "🏆 DER FALL IST GELÖST",
    "detectiveCase.solved.crewLine": "Die Crew kann aufatmen.",
    "detectiveCase.solved.rewardHeading": "DEINE BELOHNUNG",
    "detectiveCase.solved.rewardCurrency": "400 Dublonen",
    "detectiveCase.solved.rewardAvatar": "Exklusiver Avatar: Meisterdetektiv",
    "detectiveCase.solved.codeUnlocked": "Dein Geheimcode wurde freigeschaltet.",
    "detectiveCase.solved.redeemButton": "🔑 CODE EINLÖSEN",

    "detectiveCase.suspect.flitz.name": "Käpt'n Flitz",
    "detectiveCase.suspect.flitz.role": "🦜 Kapitän der FireHelmet",
    "detectiveCase.suspect.flitz.statement": "Ich war die ganze Nacht allein in meiner Kajüte und habe Karten studiert. Niemand kann das bestätigen - aber wieso sollte ausgerechnet ich die eigene Schatzkammer bestehlen?",
    "detectiveCase.suspect.andii.name": "Ändii",
    "detectiveCase.suspect.andii.role": "🐙 Herrin der Spielothek",
    "detectiveCase.suspect.andii.statement": "Ich hab die halbe Nacht die Spielothek geschmissen - fragt die Gäste, die haben mich die ganze Zeit gesehen!",
    "detectiveCase.suspect.bruno.name": "Smutje Bruno",
    "detectiveCase.suspect.bruno.role": "⚓ Schiffskoch",
    "detectiveCase.suspect.bruno.statement": "Ich war bis 23:15 Uhr in der Kombüse und hab Zwieback gebacken. Steht sogar im Küchenprotokoll.",
    "detectiveCase.suspect.finn.name": "Ausguck Finn",
    "detectiveCase.suspect.finn.role": "🔭 Wache im Ausguck",
    "detectiveCase.suspect.finn.statement": "Ich hab von meinem Posten aus die ganze Zeit aufs Hauptdeck geschaut. Da war zwischen 23:00 und 23:20 Uhr niemand.",

    "detectiveCase.clue.logbook.title": "📖 Logbuch untersuchen",
    "detectiveCase.clue.logbook.text": "Um 23:10 Uhr wurde die Schatzkammer zuletzt geöffnet.",
    "detectiveCase.clue.lookoutStatement.title": "🔭 Ausguck befragen",
    "detectiveCase.clue.lookoutStatement.text": "„Ich habe zwischen 23:00 und 23:20 Uhr niemanden auf dem Hauptdeck gesehen.“ - Aussage von Ausguck Finn.",
    "detectiveCase.clue.footprints.title": "👣 Fußspuren untersuchen",
    "detectiveCase.clue.footprints.text": "Vor der Schatzkammer wurden nasse Stiefelabdrücke gefunden. Es hatte in dieser Nacht geregnet - nass wird man nur an Deck, nicht in einer trockenen Kajüte.",
    "detectiveCase.clue.kitchenLog.title": "🍲 Küchenprotokoll prüfen",
    "detectiveCase.clue.kitchenLog.text": "Smutje Bruno war laut Küchenprotokoll bis 23:15 Uhr in der Kombüse - unabhängig bestätigt, weit weg von der Schatzkammer.",
    "detectiveCase.clue.bell.title": "🔔 Schiffsglöckchen untersuchen",
    "detectiveCase.clue.bell.text": "Um 23:12 Uhr wurde das Glöckchen an Deck ausgelöst - mitten in der Tatzeit. Ein Ablenkungsmanöver?",
  ...
  en: {
    ...
    "detectiveCase.cluesHeading": "🔎 Clues",
    "detectiveCase.boardHeading": "📌 Investigation board",
    "detectiveCase.timelineHeading": "🕰️ The night of the theft",
    "detectiveCase.timelineHint": "Every clue you investigate adds something here. Whoever contradicts themselves stands out.",
    "detectiveCase.timelineEmpty": "Nothing recorded yet. Go investigate the clues.",
    "detectiveCase.notesHeading": "📝 Your assessment",
    "detectiveCase.noteSuspect": "suspicious",
    "detectiveCase.noteCleared": "cleared",
    "detectiveCase.noteNone": "open",
    "detectiveCase.threadHint": "Pick a suspect - the threads show what is known about them.",
    "detectiveCase.clueRelation.entlastet": "speaks for them",
    "detectiveCase.clueRelation.belastet": "speaks against them",
    "detectiveCase.clueRelation.widerspruch": "contradicts their statement",
    "detectiveCase.zeit.flitzKajuete": "Cap'n Flitz: alone in his cabin (unconfirmed)",
    "detectiveCase.zeit.andiiSpielothek": "Ändii: in the arcade (guests confirm)",
    "detectiveCase.zeit.brunoKombuese": "Cookie Bruno: in the galley (kitchen log)",
    "detectiveCase.zeit.finnAusguck": "Lookout Finn: saw no one on the main deck",
    "detectiveCase.zeit.kammerOffen": "Treasure chamber last opened",
    "detectiveCase.zeit.gloeckchen": "Bell on deck triggered",
    "detectiveCase.zeit.roterMantel": "Red coat seen near the treasure chamber",
    "detectiveCase.zeit.stiefel": "Wet boot prints outside the chamber",
    "detectiveCase.investigateCta": "🔍 Investigate",
    "detectiveCase.accuseButton": "🔎 ACCUSE SUSPECT",
    "detectiveCase.confirmAccuse": "Are you sure? A false accusation could warn the real culprit.",
    "detectiveCase.wrong.title": "❌ Wrong trail.",
    "detectiveCase.wrong.text": "Your evidence isn't enough. The real culprit is still aboard.",
    "detectiveCase.wrong.hint": "Maybe you should compare the statements again.",
    "detectiveCase.solved.reveal": "🕵️ CASE SOLVED!",
    "detectiveCase.solved.revealLine1": "You've exposed the culprit.",
    "detectiveCase.solved.revealLine2": "The 400 missing doubloons have been found.",
    "detectiveCase.solved.heading": "🏆 THE CASE IS SOLVED",
    "detectiveCase.solved.crewLine": "The crew can breathe easy again.",
    "detectiveCase.solved.rewardHeading": "YOUR REWARD",
    "detectiveCase.solved.rewardCurrency": "400 doubloons",
    "detectiveCase.solved.rewardAvatar": "Exclusive avatar: Master Detective",
    "detectiveCase.solved.codeUnlocked": "Your secret code has been unlocked.",
    "detectiveCase.solved.redeemButton": "🔑 REDEEM CODE",

    "detectiveCase.suspect.flitz.name": "Cap'n Flitz",
    "detectiveCase.suspect.flitz.role": "🦜 Captain of the FireHelmet",
    "detectiveCase.suspect.flitz.statement": "I was alone in my cabin all night studying charts. No one can confirm that - but why would I steal from my own treasure chamber?",
    "detectiveCase.suspect.andii.name": "Ändii",
    "detectiveCase.suspect.andii.role": "🐙 Mistress of the Spielothek",
    "detectiveCase.suspect.andii.statement": "I ran the Spielothek half the night - ask the guests, they saw me the whole time!",
    "detectiveCase.suspect.bruno.name": "Cookie Bruno",
    "detectiveCase.suspect.bruno.role": "⚓ Ship's cook",
    "detectiveCase.suspect.bruno.statement": "I was in the galley baking hardtack until 23:15. It's even in the kitchen log.",
    "detectiveCase.suspect.finn.name": "Lookout Finn",
    "detectiveCase.suspect.finn.role": "🔭 Watch in the crow's nest",
    "detectiveCase.suspect.finn.statement": "I watched the main deck from my post the entire time. There was no one there between 23:00 and 23:20.",

    "detectiveCase.clue.logbook.title": "📖 Examine the logbook",
    "detectiveCase.clue.logbook.text": "The treasure chamber was last opened at 23:10.",
    "detectiveCase.clue.lookoutStatement.title": "🔭 Question the lookout",
    "detectiveCase.clue.lookoutStatement.text": "\"I saw no one on the main deck between 23:00 and 23:20.\" - Statement from Lookout Finn.",
    "detectiveCase.clue.footprints.title": "👣 Examine the footprints",
    "detectiveCase.clue.footprints.text": "Wet boot prints were found in front of the treasure chamber. It had rained that night - you only get wet on deck, not in a dry cabin.",
    "detectiveCase.clue.kitchenLog.title": "🍲 Check the kitchen log",
    "detectiveCase.clue.kitchenLog.text": "According to the kitchen log, Cookie Bruno was in the galley until 23:15 - independently confirmed, far from the treasure chamber.",
    "detectiveCase.clue.bell.title": "🔔 Examine the ship's bell",
    "detectiveCase.clue.bell.text": "The bell on deck was triggered at 23:12 - right in the middle of the crime window. A diversion?",
