...
const translations = {
  de: {
    ...
    "skilltree.node.legende.effect": "Der höchste Titel der Crew und ein goldener Rahmen um deine Spielerkarte. Frei erst, wenn alle drei Zweige voll ausgebaut sind.",
  ...
  en: {
    ...
    "skilltree.node.legende.effect": "The crew's highest title and a golden frame around your player card. Unlocks once all three branches are complete.",
