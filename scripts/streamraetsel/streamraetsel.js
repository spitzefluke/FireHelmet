...
function renderStreamRaetselContent() {
  ...
  contentEl.innerHTML = `
    ...
    <a href="https://vm.tiktok.com/ZGdxBbTLR/" target="_blank" class="social-btn social-tiktok" style="margin: 20px auto; width: fit-content;">
      <svg viewBox="0 0 24 24" class="social-icon"><path d="M16.6 5.8c-.9-.9-1.4-2.1-1.4-3.4h-3.3v13.6c0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.7-1.2-2.7-2.7s1.2-2.7 2.7-2.7c.3 0 .5 0 .8.1V10c-.3 0-.5-.1-.8-.1-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6V9.1c1.3.9 2.8 1.5 4.5 1.5V7.3c-1 0-2-.4-2.6-1c-.2-.2-.3-.3-.5-.5z"/></svg>
      <span>TikTok</span>
    </a>
  ...
  attachComboMatrixHoverEffect(document.getElementById("combo-check-btn"));
...
/* ------------------------------------------------------
   MATRIX-DECRYPT-HOVEREFFEKT FÜR DEN "PRÜFEN"-BUTTON
------------------------------------------------------ */
const comboMatrixChars = "!<>-_\\/[]{}—=+*^?#01ÄÖÜ";

function attachComboMatrixHoverEffect(btnEl) {
  if (!btnEl || btnEl.dataset.matrixBound) return;
  btnEl.dataset.matrixBound = "1";
    ...
    matrixInterval = setInterval(() => {
      btnEl.textContent = originalText
        ...
        .map((char, index) => {
          ...
          return comboMatrixChars[Math.floor(Math.random() * comboMatrixChars.length)];
        })
        .join("");
