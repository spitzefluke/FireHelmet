...
const streamRaetselConfig = {
  ...
  /* ------------------------------------------------------
     ZAHLEN-KETTE
     Eine Reihe von Zahlen, die NACHEINANDER freigeschaltet
     werden. Nur die erste ist zu Beginn eingebbar, alle
     weiteren sind gesperrt (🔒), bis die davor richtig gelöst
     wurde. Bei jeder richtigen Zahl erscheint eine eigene
     Nachricht (wie beim normalen Code-System). Bei falscher
     Eingabe muss man warten, bevor man's nochmal versuchen
     kann - die Wartezeit wird bei jedem weiteren Fehlversuch
     länger.

     Optional: "audio" hinzufügen (Pfad relativ zur index.html),
     damit bei dieser Zahl zusätzlich ein Abspiel-Button
     erscheint. Die Datei kann dort dann NUR 3x abgespielt
     werden (danach ist der Button dauerhaft ausgegraut).
  ------------------------------------------------------ */
  numberChain: [
    { answer: "7", message: "Richtig! Die erste Zahl ist geknackt." },
    { answer: "42", message: "Weiter geht's, zweite Zahl korrekt!" },
    { answer: "99", message: "Letzte Zahl richtig - geschafft!" },
  ],
