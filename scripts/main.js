...
function spawnWhale() {
  ...
  whale.innerHTML = `
    <div class="whale-3d">
      <svg class="whale-svg" viewBox="-40 -70 300 165" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="whaleGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stop-color="#f2fbff" stop-opacity=".95" />
            <stop offset="35%"  stop-color="#8fd0ff" stop-opacity=".82" />
            <stop offset="100%" stop-color="#0f3a8a" stop-opacity=".55" />
          </linearGradient>
          <linearGradient id="whaleShade" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stop-color="#02102b" stop-opacity="0" />
            <stop offset="100%" stop-color="#02102b" stop-opacity=".6" />
          </linearGradient>
          <linearGradient id="whaleHighlight" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stop-color="#ffffff" stop-opacity=".9" />
            <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="whaleRay" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stop-color="#dff2ff" stop-opacity=".5" />
            <stop offset="100%" stop-color="#dff2ff" stop-opacity="0" />
          </linearGradient>
          <pattern id="whaleDots" width="10" height="10" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r=".9" fill="#eaf8ff" opacity=".55" />
          </pattern>
          <filter id="whaleGlow" x="-80%" y="-80%" width="260%" height="260%">
          ...
          <filter id="whaleRimGlow" x="-100%" y="-100%" width="300%" height="300%">
            <feGaussianBlur stdDeviation="6" />
          </filter>
        </defs>

        <!-- Weiche Lichtstrahlen im Hintergrund, wie im Referenzbild -->
        <g class="whale-rays" opacity=".4">
          <path fill="url(#whaleRay)" d="M100,-70 L130,-70 L150,80 L90,80 Z" />
          <path fill="url(#whaleRay)" d="M150,-70 L175,-70 L185,80 L135,80 Z" />
        </g>

        <!-- Rand-Glow: leicht vergrößerte, weiche Kontur hinter dem eigentlichen Körper -->
        <path class="whale-rim" filter="url(#whaleRimGlow)"
              fill="none" stroke="#9fd8ff" stroke-width="4" stroke-opacity=".55"
              d="M20,50 C8,22 55,-8 120,-10 C175,-11 218,4 240,28
                 C220,38 195,42 172,40 C160,58 128,70 92,68 C62,66 34,58 20,50 Z" />

        <g filter="url(#whaleGlow)">
          <!-- Schwanzflosse mit klassischer V-Kerbe, zeitversetzt zur Körperwelle -->
          <g class="whale-tail" style="transform-origin: 20px 50px;"
             fill="url(#whaleGrad)" stroke="#cfeaff" stroke-width="1" stroke-opacity=".6">
            <path d="M20,50 C-4,42 -22,44 -44,36 C-26,50 -22,56 -30,68
                     C-20,60 -14,60 -8,64 C-16,72 -20,78 -28,88
                     C-10,76 2,68 20,58 C10,52 14,50 20,50 Z" />
          </g>

          <!-- Körper -->
          <g class="whale-body">
            <path fill="url(#whaleGrad)" stroke="#cfeaff" stroke-width="1" stroke-opacity=".6"
                  d="M20,50
                     C8,22 55,-8 120,-10
            ...
            <!-- Gepunktete Hauttextur wie im Referenzbild -->
            <path fill="url(#whaleDots)" opacity=".8"
                  d="M25,48 C15,25 58,-4 120,-6 C170,-7 205,4 225,24
                     C205,32 180,36 158,35 C148,50 120,60 90,58
                     C64,56 38,50 25,48 Z" />

            <!-- Schattenlage für Tiefe -->
            <path fill="url(#whaleShade)"
                  d="M30,52 C55,66 90,70 125,64 C160,58 190,48 215,34
                     C190,52 155,62 118,64 C78,66 48,62 30,52 Z" />

            <!-- Glanzlicht oben -->
            <path fill="url(#whaleHighlight)" opacity=".55"
                  d="M35,10 C70,-4 120,-10 165,-6 C130,-2 90,4 55,16 C48,14 41,12 35,10 Z" />

            <!-- Große Brustflosse -->
            <path fill="url(#whaleGrad)" stroke="#cfeaff" stroke-width="1" stroke-opacity=".6" opacity=".85"
                  d="M108,16 C68,-26 24,-48 -18,-42
                     C14,-18 34,8 58,26 C72,14 90,10 108,16 Z" />
            <path fill="url(#whaleDots)" opacity=".5"
                  d="M100,14 C68,-20 32,-38 0,-36 C24,-16 42,4 60,20 C74,12 88,10 100,14 Z" />
