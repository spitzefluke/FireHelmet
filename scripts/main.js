      ...
      <svg class="whale-svg" viewBox="-40 -55 300 150" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="whaleGrad" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="35%"  stop-color="#8fd0ff" stop-opacity=".8" />
            <stop offset="100%" stop-color="#123f8f" stop-opacity=".5" />
          </linearGradient>
          <linearGradient id="whaleShade" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stop-color="#02102b" stop-opacity="0" />
            <stop offset="100%" stop-color="#02102b" stop-opacity=".55" />
          </linearGradient>
        ...
        <g filter="url(#whaleGlow)">
          <!-- Schwanzflosse: folgt der Körperbewegung leicht zeitversetzt (Wellenschlag) -->
          <g class="whale-tail" style="transform-origin: 20px 50px;"
            ...
            <path d="M16,55 C-4,58 -18,66 -30,80 C-10,72 6,68 22,62 Z" opacity=".55" />
          </g>

          <!-- Körper mit Volumen: Grundform, Schattenseite unten, Glanzlicht oben -->
          <g class="whale-body">
            ...
            <!-- Glanzlicht oben für 3D-Glasoptik -->
            <path fill="url(#whaleHighlight)" opacity=".5"
                  d="M35,10 C70,-4 120,-10 165,-6 C130,-2 90,4 55,16 C48,14 41,12 35,10 Z" />

            <!-- Große Brustflosse wie eine leuchtende Schwinge -->
