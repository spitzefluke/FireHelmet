...
HTML/CSS/Vanilla-JS ohne Bundler**: `index.html` lädt 114 `<script defer>`-Tags in fester
Reihenfolge, davon 100 aus diesem Repo. `package.json` hat keine Skripte; die Abhängigkeiten (gsap, three, motion) werden
